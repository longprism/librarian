...
<head>
  ...
  <title>{{$page_title ?? 'Librarian'}}</title>
  ...
  <link rel="stylesheet" href="{{asset('bower_components/admin-lte/dist/css/skins/skin-yellow.min.css')}}">
